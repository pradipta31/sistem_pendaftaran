...
--
-- Host: localhost:3306
-- Generation Time: Jul 26, 2018 at 12:50 AM
...
(1, '2018.001', '2018-07-25', '150030010', 'asd', 'asd@gmail.com', 20, '1997-11-08', 'Sarjana Komputer', 2015, 'Hindu', 'pria', '167', '67', 'Jl. Pratu Md. Rambug, Gang Bija V, Batubulan', 'Gianyar', '0812931237', 'profile.jpg'),
...
INSERT INTO `tes` (`id_tes`, `id_peserta`, `id_hasil_tes`, `pilihan`, `benar`, `salah`, `kosong`) VALUES
(1, 4, 1, 'A,B,B,B,B,B,C,B,B,B,B,B,B,B,B,B,B,B,B,B,B,B,B,B,B,B,B,B,B,B,B,B,B,B,B,B,B,B,C,B,B,B,B,B,B,B,B', '15', '32', '3');
